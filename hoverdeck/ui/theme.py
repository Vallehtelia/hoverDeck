...
KEYCAP_HOVER_GLOW_ALPHA = 40  # soft amber wash on a hovered key's face
IMAGE_SCRIM_ALPHA = 150       # dark gradient under the label on image keys
# "Glass card" gloss on keycaps (white INK overlays; alpha 0-255).
GLASS_TOP_ALPHA = 78          # bright reflection across the top half
GLASS_STREAK_ALPHA = 64       # the diagonal specular shine streak
GLASS_LOWER_ALPHA = 22        # faint reflected light on the lower half
GLASS_HOVER_BOOST = 34        # extra brightness on all gloss while hovered
...
GLASS_MOVE_MS = 260       # keycap glass shine gliding in/out on hover
